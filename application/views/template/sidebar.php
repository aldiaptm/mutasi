    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-success elevation-4">
            ...
            <a href="<?= base_url('admin/dashboard') ?>" class="brand-link d-flex justify-content-center">
                <span class="font-weight-bold-light">SIMUWEB</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block" style="color: #fff; font">Admin</a>
                    </div>
                </div>
                <!-- Sidebar Menu -->
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/keloladatapenduduk') ?>" class="nav-link ">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/mutasimd') ?>" class="nav-link ">
                                        ...
                                        <p style="color: white; ">Mutasi Meninggal Dunia</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/mutasibt') ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p style="color: white;">Mutasi Berpindah Tempat</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
