...
<div class="card card-success">
    <div class="card-header">
        <h3 class="card-title">Tambah Data Meninggal Dunia</h3>
    </div>
    <!-- /.card-header -->
    ...
    <form action="<?= base_url('admin/tambah_aksi_meninggal') ?>" method="POST">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="tanggal_lahir" placeholder="Masukan tempat kematian"
                    name="tempat_kematian">
            </div>
            <div class="form-group">
                <label for="tempat_kelahiran">Tempat Kelahiran</label>
                <input type="text" class="form-control" id="tempat_kelahiran" placeholder="Masukan tempat kelahiran"
                    name="tempat_kelahiran">
            </div>
            <div class="form-group">
                <label for="tanggal_kelahiran">Tanggal Kelahiran</label>
                <input type="date" class="form-control" id="tanggal_kelahiran" placeholder="Masukan tanggal kelahiran"
