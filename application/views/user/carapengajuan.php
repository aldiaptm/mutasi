    ...
    <div class="container">
        ...
        <div>
            ...
            <ol>
                <li>Pastikan Anda telah login ke akun SIMUWEB sebagai pengguna terdaftar.</li>
                <li>Pilih menu <strong>Pengajuan Mutasi</strong> di sidebar.</li>
        ...
        <div>
            <h3>Catatan:</h3>
            <p>Setelah mengajukan mutasi, tunggu konfirmasi dari pihak yang berwenang terkait proses pengajuan Anda.</p>
        </div>
    </div>
